      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-4">
            ...
            <label>ID No. :</label>
            <input type="text" id="id_number_update" class="form-control" autocomplete="off" style="height:45px; border: 1px solid black; font-size: 25px;">
          </div>
          <div class="col-4">
        ...
        <div class="row">
          ...
          <div class="col-4">
            <label>Line No. :</label>
            <input type="text" id="line_no_update" class="form-control" autocomplete="off" style="height:45px; border: 1px solid black;">
          </div>
           <div class="col-4">
