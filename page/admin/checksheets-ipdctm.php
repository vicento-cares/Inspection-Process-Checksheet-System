      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card card-gray-dark card-outline">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <div id="accordion_checksheets2_legend">
                <div class="card shadow">
                  <div class="card-header">
                    <h4 class="card-title w-100">
                      <a class="d-block w-100 text-dark" data-toggle="collapse" href="#collapseOneChecksheets2Legend">
                        IPDCTM Status Legend
                      </a>
                    </h4>
                  </div>
                  <div id="collapseOneChecksheets2Legend" class="collapse" data-parent="#accordion_checksheets2_legend">
                    <div class="card-body">
                      <div class="row">
              ...
              <div class="table-responsive" style="max-height: 500px; overflow: auto; display:inline-block;">
                <table id="pendingChecksheetsTable" class="table table-sm table-head-fixed text-nowrap table-hover">
                  ...
                  <tbody id="pendingChecksheetsData" style="text-align: center;">
                    <tr style="cursor:pointer;" class="modal-trigger bg-danger" data-toggle="modal" data-target="#checksheets_2_modal">
                      <td>1</td>
                      <td>IPDCTM-001</td>
                      <td>2023-08-01</td>
                      <td>Suzuki</td>
                    ...
                    <tr style="cursor:pointer;" class="modal-trigger bg-warning" data-toggle="modal" data-target="#checksheets_2_modal">
                      <td>2</td>
                      <td>IPDCTM-002</td>
                      <td>2023-08-01</td>
                      <td>Suzuki</td>
