...
<?php include 'plugins/sidebar/checksheets-dirr_bar.php';?>
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0"><b>DIRR Checksheets</b> (MEI-074F1)</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card card-gray-dark card-outline">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <div id="accordion_checksheets3_legend">
                <div class="card shadow">
                  <div class="card-header">
                    <h4 class="card-title w-100">
                      <a class="d-block w-100 text-dark" data-toggle="collapse" href="#collapseOneChecksheets3Legend">
                        DIRR Status Legend
                      </a>
                    </h4>
                  </div>
                  <div id="collapseOneChecksheets3Legend" class="collapse" data-parent="#accordion_checksheets3_legend">
                    <div class="card-body">
                      <div class="row">
              ...
              <div class="table-responsive" style="max-height: 500px; overflow: auto; display:inline-block;">
                <table id="pendingChecksheetsTable" class="table table-sm table-head-fixed text-nowrap table-hover">
                  ...
                  <tbody id="pendingChecksheetsData" style="text-align: center;">
                    <tr style="cursor:pointer;" class="modal-trigger bg-danger" data-toggle="modal" data-target="#checksheets_3_modal">
                      <td>1</td>
                      <td>DIRR-001</td>
                      <td>2023-08-01</td>
                      <td>Suzuki YD1</td>
                    ...
                    <tr style="cursor:pointer;" class="modal-trigger bg-warning" data-toggle="modal" data-target="#checksheets_3_modal">
                      <td>1</td>
                      <td>DIRR-002</td>
                      <td>2023-08-01</td>
                      <td>Suzuki Y21</td>
...
<?php include 'plugins/js/checksheets-dirr_script.php';?>