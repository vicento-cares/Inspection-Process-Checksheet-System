...
if ($method == 'get_checksheet_info_today') {
	$response_arr = array();
	if ($server_time >= '08:00:00' && $server_time < '20:00:00') {
	    $shift = 'Shift A';
	} else if ($server_time >= '20:00:00' && $server_time <= '23:59:59') {
	    $shift = 'Shift B';
	} else if ($server_time >= '00:00:00' && $server_time < '08:00:00') {
	    $shift = 'Shift B';
	}
	$response_arr = array(
		'd_inspection_date' => $server_date_only,
		'a_inspector_name' => $_SESSION['name'],
		'shift' => $shift
	);
